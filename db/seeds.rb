...
200.times do
  ...
  passenger_capacity_gen = rand(50..250)
  this_flight_length = rand(1..12)
  flight_start = DateTime.new(2022,5,(5+(rand(1..10))),(rand(0...24)), rand(0...60))
  Flight.create(departure_airport_id: depart, arrival_airport_id: arrival, passenger_capacity: passenger_capacity_gen, departure: flight_start, flight_length: this_flight_length)
end
